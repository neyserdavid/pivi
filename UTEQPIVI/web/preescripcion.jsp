        ...
        <header style="background: #17466B;  justify-content: space-around;">
            ...
            <nav style="z-index:20">
                <ul>
                    ...
                    <li class="sub-menu"><a href="#">Configuración</a>
                        <ul>
        ...
        <div style="max-width: 1300px; margin: auto;">
            <nav aria-label="breadcrumb" style="width: 90%; margin: auto;">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Prescripción</li>
                </ol>
            </nav>
    ...
    <div class="modal-dialog" role="document">
        <form action="Login">
            <div class="modal-content">
                ...
                <p style="text-align: center;">¿Olvidó su contraseña?</p>
            </div>
        </form>
    </div>
</div>   
